  ...
  return (
    <Container>
      <DistributionCountContainer>
        ...
        <Base1000Text
          variant="b3_R"
        >{t('pages.coin-detail.$coinId.manage-stake.entry.Sui.components.EpochIndicator.index.nextRewardShare')}</Base1000Text>
      </DistributionCountContainer>

      <EpochContainer>
        <Base1000Text
          variant="b4_R"
        >{t('pages.coin-detail.$coinId.manage-stake.entry.Sui.components.EpochIndicator.index.currentEpoch')}</Base1000Text>
